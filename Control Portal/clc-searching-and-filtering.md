...
At times the search may want to filter your list of Infrastructure down to particular items so you can focus on them. This can be accomplished by using the **Filter** option located at the top of your lists.
...
4. While the filter is still applied, you can navigate between all the results. To close the filter, click the **x** on the filter bar. Canceling the filter brings all Infrastructure back into view.
...
Selecting any item in the search will take you to that item. The following steps include examples of searching basics:
...
2. Enter your search criteria. This example uses a simple text string.
...
4. This time search for who created the server. This example searches on a user name. Clicking on a line item takes you to the drill-down information.
...
Make use of the powerful search and filtering abilities in the platform. It can help you more easily manage large deployments. Using these features helps you to quickly navigate to, and find, key components very quickly.
